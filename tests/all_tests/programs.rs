...
test_program! {
	find_max [
		["28u0", "1u0"] -> [0, "0u0"]		: [ shared_metrics([1]) ]
		["28u0", "2u0"] -> [1, "1u0"]		: [ shared_metrics([2]) ]
		["30u0", "4u0"] -> [4, "4u0"]		: [ shared_metrics([4]) ]
		["35u0", "3u0"]	-> [99, "99u0"]		: [ shared_metrics([3]) ]
		["34u0", "7u0"]	-> [207, "207u0"]	: [ shared_metrics([7]) ]
	]
